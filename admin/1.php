...
$statement = $pdo->prepare("SELECT * FROM facecones");
$statement->execute();
  ...
  <body>
      ...
      >
        ...
        <nav id="navbar" class="navbar order-last order-lg-0">
          <ul>
            ...
            <li><a class="nav-link scrollto active" href="mint1.php">MINT NFT</a></li>
          </ul>
    ...
    <section class="collections">
      ...
      <h2 align="center" class="name" style="font-size: 80px;">  
         <?php 
      $statement = $pdo->prepare("SELECT * FROM facecones order by date desc");
      $statement->execute();
      $collections = $statement->fetchAll(PDO::FETCH_ASSOC);
      ...
      <div class="btn">
        <a href="mint1.php" class="btn btn-success " >+   MINT NFT</a>
      </div>
    </section>
...
<td>
  <form action="deletefc.php" method="post">
