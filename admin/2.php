...
$statement = $pdo->prepare("SELECT * FROM boredapes order by date desc;");
$statement->execute();
  ...
  <body>
      ...
      >
        ...
        <nav id="navbar" class="navbar order-last order-lg-0">
          <ul>
            ...
            <li><a class="nav-link scrollto active" href="mint2.php">MINT NFT</a></li>
          </ul>
    ...
    <section class="collections">
      ...
      <div class="info">
        ...
        <div class="desc">
        The Bored Ape Yacht Club is a collection of 10,000 unique Bored Ape NFTs— unique digital collectibles living on the DAMMS. 
        </div>
      </div>
      ...
      <div class="btn">
        <a href="mint2.php" class="btn btn-success " >+   MINT NFT</a>
      </div>
    </section>
...
<td>
  <form action="deleteba.php" method="post">
