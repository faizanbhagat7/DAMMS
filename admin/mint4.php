...
<html lang="en">
  <head>
    ...
    <title>Classic Collection</title>
      ...
      >
        ...
        <nav id="navbar" class="navbar order-last order-lg-0">
          <ul>
            ...
            <li><a class="nav-link scrollto " href="4.php">Collection</a></li>
          </ul>
...
if(isset($_FILES['image']) and $_POST['name'] and $_POST['price']){
   ...
   $sql = "SELECT * FROM  classiccollection WHERE name = '".$_POST['name']."'";
  ...
  // $file_type = $_FILES['image']['type'];
   ...
   $dest_file = "upload-classiccollection/".$file_name;
  ...
  $sql = "INSERT INTO classiccollection (name,price,image) VALUES ('$name','$price','$dest_file')";
  $result = mysqli_query($conn,$sql);
  if($result){
