      ...
      >
        ...
        <nav id="navbar" class="navbar order-last order-lg-0">
          <ul>
            ...
            <li><a class="nav-link scrollto " href="3.php">Collection</a></li>
          </ul>
...
if(isset($_FILES['image']) and $_POST['name'] and $_POST['price']){
    ...
    $sql = "SELECT * FROM  invisiblefriends WHERE name = '".$_POST['name']."'";
  ...
  $file_tmp = $_FILES['image']['tmp_name'];
   ...
   $dest_file = "upload-invisiblefriends/".$file_name;
  ...
  $sql = "INSERT INTO invisiblefriends (name,price,image) VALUES ('$name','$price','$dest_file')";
  $result = mysqli_query($conn,$sql);
  if($result){
