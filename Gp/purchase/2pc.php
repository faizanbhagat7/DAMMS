...
include '../../config/config.php';
   ...
   $name = $_POST['name'];
    ...
    $sql = "UPDATE `boredapes` SET `owner` = '$user' WHERE `boredapes`.`name` = '$name'";
    $result = mysqli_query($conn, $sql);
    ...
    $result = mysqli_query($conn, $sql);
        ...
        $to = ($mail);
        $subject = "Bored Apes NFT Purchase from DAMMS";
        $message = '🚀 Congratulations!
Hey '.$user.',
You own a '.$name.' NFT worth '.$price.' eth from Bored Apes collection.';
