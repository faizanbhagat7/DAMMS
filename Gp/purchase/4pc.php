...
include '../../config/config.php';
    ...
    $sql = "SELECT * FROM classiccollection WHERE name = '$name'";
...
include '../../config/config.php';
   ...
   $name = $_POST['name'];
    ...
    $sql = "UPDATE `classiccollection` SET `owner` = '$user' WHERE `classiccollection`.`name` = '$name'";
    $result = mysqli_query($conn, $sql);
    ...
    $result = mysqli_query($conn, $sql);
        ...
        $to = ($mail);
        $subject = "Classic Collection NFT Purchase from DAMMS";
        $message = '🚀 Congratulations!
Hey '.$user.',
You own a '.$name.' NFT worth '.$price.' eth from Classic collection.';
