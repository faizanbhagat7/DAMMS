...
include '../../config/config.php';
    ...
    $sql = "SELECT * FROM facecones WHERE name = '$name'";
...
include '../../config/config.php';
   ...
   $name = $_POST['name'];
    ...
    $sql = "UPDATE `facecones` SET `owner` = '$user' WHERE `facecones`.`name` = '$name'";
    $result = mysqli_query($conn, $sql);
    ...
    $to = ($mail);
    $subject = "Face Cones NFT Purchase from DAMMS";
    $message = '🚀 Congratulations!
Hey '.$user.',
You own a '.$name.' NFT worth '.$price.' eth from Face Cones collection.';
