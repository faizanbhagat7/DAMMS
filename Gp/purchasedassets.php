  ...
  <body>
      ...
      >
        ...
        <nav id="navbar" class="navbar order-last order-lg-0">
          <ul>
            ...
            <li><a class="nav-link scrollto active" href="purchasedassets.php">Purchased Assets</a></li>
          </ul>
    ...
    <section class="collections">
      ...
      <div class="info">
        ...
        View  Assets owned by you. <br/>
        You can view all the NFT's possessed by you.
        <br> Time to show off your collection!
        </div>
      </div>
