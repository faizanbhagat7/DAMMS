...
$statement = $pdo->prepare("SELECT * FROM invisiblefriends where owner IS NULL");
$statement->execute();
...
<html lang="en">
  ...
  <body>
    ...
    <section class="collections1">
      <!--logo  -->
      <div class="logo">
        <img src="assets/img/invisible.gif" alt="" />
      </div>
...
Invisible Friends is a Random Character Collective project.
      ...
      <h2 align="center" class="name" style="font-size: 80px;">  
         <?php 
      $statement = $pdo->prepare("SELECT * FROM invisiblefriends  where `owner` IS NULL order by date desc");
      $statement->execute();
      $collections = $statement->fetchAll(PDO::FETCH_ASSOC);
